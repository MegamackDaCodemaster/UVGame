...
public class Skeleton implements Monster {
    ...
    /**
     * Constructs a default {@code Skeleton} with pre-defined stats.
     */
    public Skeleton() {
        this("Skeleton", "a bony fellow with a huge sword", 30, 40, 20);
    }

    public Skeleton(String monsterName, String description, int rewardPoints, int health, int strength) {
