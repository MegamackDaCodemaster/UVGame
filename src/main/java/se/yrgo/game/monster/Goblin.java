...
public class Goblin implements Monster{
    ...
    /**
     * Constructs a default {@code Goblin} with pre-defined stats.
     */
    public Goblin() {
        this("Goblin", "a sneaky goblin", 10, 10, 15);
    }

    public Goblin(String monsterName, String description, int rewardPoints, int health, int strength) {
